...
var require_iconify = __commonJS({
  "node_modules/@iconify/react/dist/iconify.js"(exports) {
    ...
    var IconComponent = class extends React.Component {
      constructor(props) {
        super(props);
        this.state = {
    ...
    var InlineIcon = React.forwardRef(function InlineIcon2(props, ref) {
      const newProps = {
        ...props,
        _ref: ref,
        _inline: true
...
export default require_iconify();
