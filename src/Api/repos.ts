export const repos = [
    {
        ...
        language: ['C#'],
        languages_url:
            'https://api.github.com/repos/1MarcosAquino/calculadora-simples_TDD_Cshap/languages',
        created_at: 'string',
        updated_at: 'string',
    },

    {
        ...
        languages_url:
            'https://api.github.com/repos/1MarcosAquino/DEMONSTRATIVO_DE_RESULTADO/languages',
        created_at: 'string',
        updated_at: 'string',
    },

    {
        ...
        language: ['HTML', 'CSS', 'JavaScript'],
        languages_url:
            'https://api.github.com/repos/1MarcosAquino/PRODUTOS_PARADOS_NO_ESTOQUE/languages',
        created_at: 'string',
        updated_at: 'string',
    },
